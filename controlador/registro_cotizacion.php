...
if (!empty($_POST['submit'])) {
    ...
    if (
        ...
        if(str_contains($newstring, 'png') OR str_contains($newstring, 'jpg' OR str_contains($newstring, 'jpeg'))){
            ...
            (fecha,empresa,email_contacto,telefono,material,tamano,url_imagen,
            precio,estado,tipo) VALUES 
             ('$fecha','$nombre_empresa','$email','$telefono','$material',
             '$tamano','$ruta',$precio,'PENDIENTE','$estructura')";
